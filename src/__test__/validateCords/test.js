...
test('validate userInput', () => {
  ...
  const type2 = timeLine.popup.validateInput('   12.3, 5.52]');
...
<div class="input-wrap">
    ...
    <span class="microfone-icon"></span>
    <span class="microfone-ok-btn hide-mic"></span>
    <span class="microfone-timer hide-mic">
        <span class="microfone-timer-minutes">00</span>
        <span class="microfone-timer-seconds">00</span>
    </span>
    <span class="microfone-cancel-btn hide-mic"></span>
</div>
</div>
</div>
...
<div class="popup-warning hidden" audio="false">
